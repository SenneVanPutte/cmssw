...
//
RecHitAnalyzer::RecHitAnalyzer(const edm::ParameterSet& iConfig): iPset(iConfig), 
...
void
RecHitAnalyzer::FillAuxilaryPlots(DetId detId, unsigned int subDetId, const TrackerTopology * tt, double dx, double dy, double dz
